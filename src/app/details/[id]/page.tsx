...
const MovieDetails = () => {
  ...
  return (
    <main
      className="bg-secondary p-8 relative max-h-[calc(100vh-77px)] min-h-[calc(100vh-77px)] overflow-y-scroll scrollbar-thin scrollbar-thumb-[#22222a] scrollbar-track-primary"
      ref={mainRef}
    >
      {movie === null && <Loading />}
